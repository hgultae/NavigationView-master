...
import com.android4dev.navigationview.api.IService;
...
public class MainActivity extends AppCompatActivity {
            ...
            public boolean onNavigationItemSelected(MenuItem menuItem) {
                ...
                switch (menuItem.getItemId()){
                    ...
                    case R.id.food:
                        ...
                        // pass network data only when they select an option from nav drawer
                        Intent i = new Intent(MainActivity.this, MapsActivity.class);
                        i.putExtra("apiData", apiDataObject);
                        startActivity(i);
    ...
    // perform network request and get the data
    public void performRequest(){
        ...
        IService iService = restAdapter.create(IService.class);
        iService.getRestuarants(new Callback<ApiData>() {
            @Override
